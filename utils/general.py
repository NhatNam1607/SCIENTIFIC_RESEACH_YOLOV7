...
def non_max_suppression(prediction, conf_thres=0.3, iou_thres=0.2, classes=None, agnostic=False, multi_label=False,
                        labels=()):
...
def non_max_suppression_kpt(prediction, conf_thres=0.3, iou_thres=0.2, classes=None, agnostic=False, multi_label=False,
